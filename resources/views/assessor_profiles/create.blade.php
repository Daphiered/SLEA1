    ...
    <div class="col-md-8">
        <div class="card">
            <div class="card-header">
                <h4 class="mb-0">Create New Assessor Profile</h4>
            </div>
            <div class="card-body">
                @if ($errors->any())
                ...
                <form action="{{ route('assessor_profiles.store') }}" method="POST">
                    @csrf
                    
                    <div class="mb-3">
                        <label for="assessor_id" class="form-label">Assessor ID *</label>
                        <input type="text" class="form-control @error('assessor_id') is-invalid @enderror" 
                               id="assessor_id" name="assessor_id" value="{{ old('assessor_id') }}" required>
                        @error('assessor_id')
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control @error('picture_path') is-invalid @enderror" 
                               id="picture_path" name="picture_path" value="{{ old('picture_path') }}" 
                    ...
                    <div class="mb-3">
                        ...
                        <input type="date" class="form-control @error('date_upload') is-invalid @enderror" 
                               id="date_upload" name="date_upload" value="{{ old('date_upload') }}" required>
                        @error('date_upload')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="d-flex justify-content-between">
                        <a href="{{ route('assessor_profiles.index') }}" class="btn btn-secondary">Cancel</a>
