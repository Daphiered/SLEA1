    ...
    <div class="col-md-8">
        <div class="card">
            <div class="card-header">
                <h4 class="mb-0">Edit Password Change Record</h4>
            </div>
            <div class="card-body">
                @if ($errors->any())
                ...
                <form action="{{ route('change_assessor_passwords.update', $change_assessor_password) }}" method="POST">
                    @csrf
                    @method('PUT')
                    
                    <div class="mb-3">
                        <label for="change_pass_id" class="form-label">Change ID</label>
                        <input type="text" class="form-control" id="change_pass_id" 
                               value="{{ $change_assessor_password->change_pass_id }}" readonly>
                        <small class="form-text text-muted">Change ID cannot be modified</small>
                    </div>
                        ...
                        <select class="form-select @error('email_address') is-invalid @enderror" 
                            ...
                            @foreach($accounts as $account)
                                <option value="{{ $account->email_address }}" 
                                        {{ old('email_address', $change_assessor_password->email_address) == $account->email_address ? 'selected' : '' }}>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control @error('old_password_hashed') is-invalid @enderror" 
                               id="old_password_hashed" name="old_password_hashed" 
                               value="{{ old('old_password_hashed', $change_assessor_password->old_password_hashed) }}" 
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control @error('new_password_hashed') is-invalid @enderror" 
                               id="new_password_hashed" name="new_password_hashed" 
                               value="{{ old('new_password_hashed', $change_assessor_password->new_password_hashed) }}" 
                    ...
                    <div class="mb-3">
                        ...
                        <input type="date" class="form-control @error('date_pass_changed') is-invalid @enderror" 
                               id="date_pass_changed" name="date_pass_changed" 
                               value="{{ old('date_pass_changed', $change_assessor_password->date_pass_changed) }}" required>
                    ...
                    <div class="d-flex justify-content-between">
                        <a href="{{ route('change_assessor_passwords.show', $change_assessor_password) }}" class="btn btn-secondary">Cancel</a>
